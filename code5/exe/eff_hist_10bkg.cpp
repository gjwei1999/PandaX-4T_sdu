...
int main(const int argc, const char * argv[]){
    ...
    TString eff_root = path + "eff_10bkg.root";
    ...
    double rate_bkg = (7558.48*0.1 + 9.20852 + 0.00874182) / 24.0 / 60.0 / 60.0;//10%ER+NR
...
void plot(){
    ...
    TString pdfpath = "/Users/jiaweiguo/Documents/GitHub/PandaX-4T_sdu/code5/plots/10_bkg/";
    TString loadpath = "/Users/jiaweiguo/Documents/GitHub/PandaX-4T_sdu/code5/output/eff_10bkg.root";
...
void contour_3sigma(){
    ...
    leg->AddEntry(far, "FAR=1/week(10% ER) ", "l");
    
    TCanvas * c0 = new TCanvas("c0", "", 800, 600);
    c0->SetLogx();
    eff1000->GetXaxis()->SetTitle("T_{SN} (s)");
    eff1000->GetYaxis()->SetTitle("N_{thr}");
    eff1000->SetTitle("3#sigma Trigger Efficiency & False Alert Rate(10% ER) ");
    eff1000->SetStats(0);
...
void contour_5sigma(){
    ...
    eff1000->GetXaxis()->SetTitle("T_{SN} (s)");
    eff1000->GetYaxis()->SetTitle("N_{thr}");
    eff1000->SetTitle("5#sigma Trigger Efficiency & False Alert Rate(10% ER) ");
    eff1000->SetStats(0);
